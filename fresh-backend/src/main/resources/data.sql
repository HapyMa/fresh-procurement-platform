...
-- 插入测试需求合并组
INSERT INTO demand_groups (category_id, product_name, city, total_quantity, unit, merge_deadline, status) VALUES
(7, '土豆', '成都市', 450.00, '斤', '2025-12-31T18:00:00', 2),
(8, '西红柿', '成都市', 280.00, '斤', '2025-12-31T20:00:00', 2);

-- 插入测试需求
INSERT INTO demands (group_id, buyer_id, category_id, product_name, quantity, unit, max_price, quality_requirement, delivery_address_id, delivery_date, delivery_time_slot, status) VALUES
...
-- 插入测试报价
INSERT INTO quotes (group_id, supplier_id, unit_price, total_amount, valid_hours, expire_at, remark, status) VALUES
